    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="get" action="{{ route('cetak.detail.prodi')}}" class="d-block d-md-flex justify-content-end">
                        @csrf()
                        ...
                        @endif
                        <a href="{{ route('cetak.detail.prodi')}}" target="_blank" class="btn btn-primary">Cetak <i class="fa-solid fa-print"></i></a>
                        </div>
                    </form>
